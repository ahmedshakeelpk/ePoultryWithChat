...
class FollowedChannel: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(GetAllFollowedChannels), name: NSNotification.Name(rawValue: "GetAllchannels"), object: nil)
...
//        }
    ...
    */
    ...
    @objc func GetAllFollowedChannels()
    {
        // let userid = defaults.value(forKey: "userid") as! String
        let url = BASEURL+"channels/\(defaults.value(forKey: "userid") ?? "")"
        print(url)
...
extension FollowedChannel: IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        let itemInfo = IndicatorInfo(title: "Followed Channels")
        return itemInfo
    }
